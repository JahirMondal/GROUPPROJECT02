...
\begin{figure}
    \centering
    \includegraphics[width=0.3\linewidth]{Makaut logo.jpg}
\end{figure}
...
\begin{enumerate}
        \item Rajkumar Pal BCA (Leader)
        \item Jahir Mondal Bsc in IT(AI) 
        \item Arnab Pandit Bsc in IT(CS)
        \item Pritam Pratihar BCA
        \item Suhana Pervaze BCA
\end{enumerate}
...
\title{Lab Entry By\\[0.5cm] \large Rajkumar Pal\\[0.5cm]
    \begin{figure}
    \centering
    \includegraphics[width=0.5\linewidth]{Github images.jpeg} % Ensure the image is correctly located
\end{figure}
\author{}
\date{}
...
\title{Lab Entry By\\[0.5cm] \large Arnab Pandit\\[0.5cm]
...
\author{\centering \Large \textbf{Lab Entry By} \\[0.5cm] \large Pritam Pratihar}
...
- \texttt{}: This command inserts the image file named \texttt{example-image}. The optional argument \texttt{width=0.5\textwidth} scales the image to 50% of the text width. You can adjust the width as needed, or use \texttt{height} or \texttt{scale} to control the image size.
...
\begin{itemize}
    \item \texttt{scale}: Scale the image by a factor. For example, \texttt{} scales the image to 75% of its original size.
    \item \texttt{height} and \texttt{width}: Specify the height or width of the image. For instance, \texttt{} sets the height of the image to 5 cm, while preserving the aspect ratio.
    \item \texttt{angle}: Rotate the image by a specified angle. For example, \texttt{} rotates the image 90 degrees clockwise.
\end{itemize}
...
\author{\centering \Large \textbf{Lab Entry By} \\[0.5cm] \large \textbf{Suhana Pervaze}}
\begin{document}
...
\begin{enumerate}
        \item Jahir Mondal Bsc in IT(AI) (Leader)
        \item Rajkumar Pal BCA
        \item Arnab Pandit Bsc in IT(CS)
        \item Pritam Pratihar BCA
        \item Suhana Pervaze BCA
\end{enumerate}
...
This project not only highlights fundamental programming concepts such as functio**